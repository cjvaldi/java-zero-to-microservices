public class Automovil implements Comparable<Automovil>{
    ...
    private static int capacidadEstanqueEstatico = 30; // las variables static solo se usan en funciones estatics
    ...
    public Automovil(String fabricante, String modelo) {
        this();   // llama al constructor anterior y este incremente el id
...
//        sb.append("\nauto.cilindrada = "+ this.cilindrada);
        ...
        detalle += "\nauto.color = " + this.color.getColor() +   // se puede usar también getColor()
                "\nauto.patente = " + colorPatente.getColor();
    ...
    //  static solo implementa variables estaticas ??
    ...
    public boolean equals(Object obj) {
        ...
        // para evitar que al no ser mismo tipo arroje una excepción
