...
C142_EjemploAutomovilArreglos {
    public static void main(String[] args) {
        ...
        Persona pato = new Persona("Pato", "Jones");
        ...
        audi.setConductor(new Persona("Jano", "Rodriguez"));
        ...
        // es el método que se ha implementado y modificado
        Arrays.sort(autos);
