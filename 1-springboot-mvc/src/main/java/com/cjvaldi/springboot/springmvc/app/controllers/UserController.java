package com.cjvaldi.springboot.springmvc.app.controllers;

import com.cjvaldi.springboot.springmvc.app.entities.User;
import com.cjvaldi.springboot.springmvc.app.services.UserService;
...
public class UserController {
    ...
    public String view(Model model) {
        ...
        model.addAttribute("user", new User("Cristian", "Valdivieso"));
        return "view";
    }
    ...
    @PostMapping
//    public String form(@ModelAttribute("user") User user, RedirectAttributes redirect) {
