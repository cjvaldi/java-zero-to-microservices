...
public class EjemploScheduledExecutorServicePeriodo {
    public static void main(String[] args) throws InterruptedException {
        ...
        //CountDownLatch lock = new CountDownLatch(5);  // inicia un decremento //otra alternativa
        ...
        while (contador.get() >= 0) {      // se usa con AtomicInteger
            if (contador.get() == 0) {
                future.cancel(true);
                contador.getAndDecrement();
            }
        ...
        executor.shutdown();  //apaga la tarea
    }
}
