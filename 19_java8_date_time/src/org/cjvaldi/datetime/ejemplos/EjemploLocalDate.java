...
public class EjemploLocalDate {
    public static void main(String[] args) {
        ...
        fechaActual = LocalDate.of(2026,06,06);
        System.out.println("fechaActual = " + fechaActual);
        fechaActual = LocalDate.of(2026, Month.JUNE,06);
        System.out.println("fechaActual = " + fechaActual);

        fechaActual = LocalDate.parse("2026-06-06");
        System.out.println("fechaActual = " + fechaActual);
        ...
        DayOfWeek miercoles = LocalDate.parse("2026-06-06").getDayOfWeek();
        System.out.println("miercoles = " + miercoles);

        int once = LocalDate.of(2026,06,06).getDayOfMonth();
