...
import com.cjvaldi.springboot.datajpa.app.models.entity.ItemFactura;
...
//		Factura factura = clienteService.finFacturaById(id);
	...
	public String eliminar(@PathVariable(value="id") Long id, RedirectAttributes flash) {
		...
		flash.addFlashAttribute("error","La factura no existe en la DB, no se pudo eliminar");
		return "redirect:/listar";
	}
