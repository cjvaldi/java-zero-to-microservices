package com.cjvaldi.appfacturas.modelo;
...
//            if (item == null) {    // al llegar solo al indice ya no encuentra null
//                continue;
//            }
...
//            }
            sb.append(this.items[i].toString())
                    .append("\n");
//            sb.append(item.getProducto().getCodigo())  // se cambia por el toString
//                    .append("\t")
