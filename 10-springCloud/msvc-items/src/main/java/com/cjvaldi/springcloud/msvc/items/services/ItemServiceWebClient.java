...
//@Primary // @Qualifier en ItemController
@Service
public class ItemServiceWebClient implements ItemService {
    ...
    public List<Item> findAll() {
        return this.client.build()
                .get()
                // .uri("http://msvc-products")  se quita por coloca en webclientconfig
    ...
    public Optional<Item> findById(Long id) {
        ...
        params.put("id", id);
        try {
            // return Optional.of(client.build().get().uri("http://msvc-products/{id}", params)  se quita por coloca en webclientconfig
