package org.cjvaldi.anotaciones.ejemplo.procesador;

import org.cjvaldi.anotaciones.ejemplo.Init;
import org.cjvaldi.anotaciones.ejemplo.JsonAtributo;
import org.cjvaldi.anotaciones.ejemplo.procesador.exception.JsonSerializadorException;
        ...
        return Arrays.stream(atributos)
                ...
                .map(f -> {
                    ...
                    try {
                        ...
                        if (f.getAnnotation(JsonAtributo.class).capitalziar() &&
                                valor instanceof String) {
                            /* String nuevoValor = (String) valor;   // solo la primera letra
                            nuevoValor = String.valueOf(nuevoValor.charAt(0)).toUpperCase()+
                                    nuevoValor.substring(1).toLowerCase(); */
                            String nuevoValor = (String) valor;  // para cada una de las palabras
